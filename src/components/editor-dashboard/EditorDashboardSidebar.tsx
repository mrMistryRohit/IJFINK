...
type EditorDashboardSidebarProps = {
        ...
        <div className={`flex items-center ${isCollapsed ? "justify-center" : "gap-3"}`}>
          ...
          {!isCollapsed && (
            <div className="leading-tight">
              ...
              <p className="text-xs font-semibold text-white/70">Editor Workspace</p>
            </div>
          )}
        </div>
      </div>
...
export default EditorDashboardSidebar;
