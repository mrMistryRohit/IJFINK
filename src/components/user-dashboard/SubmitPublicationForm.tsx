  ...
  return (
    <section className="space-y-6">
      <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
        ...
        <p className="mt-2 max-w-3xl text-sm leading-relaxed text-slate-500">This is now a step-by-step submission flow. Each page is a separate route so authors can move through the backend-aligned process one screen at a time.</p>
      </div>
